...
function ExtrasMenu(props) {
    ...
    function menuButton1Click() {
      current_transaction.add_to_transaciton(menu_object.extras_id_array[0 + (currentPage * 9)]); 
    ...
    function menuButton2Click() {
      current_transaction.add_to_transaciton(menu_object.extras_id_array[1 + (currentPage * 9)]); 
      updateOrderText(current_transaction.to_string());
      forceUpdate();
    }
  
    function menuButton3Click() {
      current_transaction.add_to_transaciton(menu_object.extras_id_array[2 + (currentPage * 9)]); 
      updateOrderText(current_transaction.to_string());
      forceUpdate();
    }
  
    function menuButton4Click() {
      current_transaction.add_to_transaciton(menu_object.extras_id_array[3 + (currentPage * 9)]); 
      updateOrderText(current_transaction.to_string());
      forceUpdate();
    }
  
    function menuButton5Click() {
      current_transaction.add_to_transaciton(menu_object.extras_id_array[4 + (currentPage * 9)]); 
      updateOrderText(current_transaction.to_string());
      forceUpdate();
    }
  
    function menuButton6Click() {
      current_transaction.add_to_transaciton(menu_object.extras_id_array[5 + (currentPage * 9)]); 
      updateOrderText(current_transaction.to_string());
      forceUpdate();
    }
  
    function menuButton7Click() {
      current_transaction.add_to_transaciton(menu_object.extras_id_array[6 + (currentPage * 9)]); 
      updateOrderText(current_transaction.to_string());
      forceUpdate();
    }
  
    function menuButton8Click() {
      current_transaction.add_to_transaciton(menu_object.extras_id_array[7 + (currentPage * 9)]); 
      updateOrderText(current_transaction.to_string());
      forceUpdate();
    }
  
    function menuButton9Click() {
      current_transaction.add_to_transaciton(menu_object.extras_id_array[8 + (currentPage * 9)]); 
      updateOrderText(current_transaction.to_string());
      forceUpdate();
    }
